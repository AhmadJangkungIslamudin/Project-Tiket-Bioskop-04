...
riwayat_path = 'riwayat pembelian.csv'
riwayat = pd.read_csv(riwayat_path)
kode_unik = riwayat['kode']
...
def transaksi(jenis_transaksi):
    ...
    if jenis_transaksi =='1':
        ...
        if konfirmasi_bayar == 'y':
            print("Buktikan kalau Anda bukan robot")
        elif konfirmasi_bayar != 'y':
            pilihfilm()
       
        while True:
            kode_bayar = str(input("Ketik '12345' =  "))
